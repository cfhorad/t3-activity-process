...
export function DashboardItemCard({
	...
	return (
		<Card
			className="group flex w-full cursor-pointer flex-col items-stretch transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
			onClick={onClick}
			variant="secondary"
		>
			...
			{hasActions && (
				<Card.Content className="px-4 pt-0 pb-2">
					<Accordion
						className="w-full"
						hideSeparator
